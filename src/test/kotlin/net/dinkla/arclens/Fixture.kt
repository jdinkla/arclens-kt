...
internal val kotlinFile =
    KotlinFile(
        ...
        PackageName("net.dinkla.arclens"),
...
internal val kotlinFile2 =
    KotlinFile(
        ...
        PackageName("net.dinkla.arclens"),
        imports = expectedImports + listOf(Import(ImportedElement("net.dinkla.arclens.some"))),
        declarations = listOf(f2, p1),
    )

val examplePackage = Package(PackageName("net.dinkla.arclens"), listOf(kotlinFile1, kotlinFile2))
